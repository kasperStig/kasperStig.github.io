        ...
        return (
            <Player name="Zerath">
                ...
                <Grouping name="Spells">
                    <ChargeResource name="1st level" charges={4} spend={4} />
                    <ChargeResource name="2nd level" charges={3} spend={2} />
                    <ChargeResource name="3rd level" charges={2} spend={2} />
                </Grouping>
                <Grouping name="Items">
                    <ChargeResource name="Ring of Rebellion" charges={2} />
                    <ChargeResource name="Box of Beasts" charges={1} spend={1} />
