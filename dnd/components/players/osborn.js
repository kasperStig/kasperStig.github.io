        ...
        return (
            <Player name="Osborn">
                <Grouping name="Resources">
                    <TransitionResource name="Ammunition" transition="d12,d10,d8,d6,d4,1,0" current="d8"/> 
                    <ChargeResource name="Hit Die" charges={5} spend={4} onShortRest={(spend) => spend - 1 < 0 ? 0 : spend - 1} />
                ...
                <Grouping name="Spells">
                    ...
                    <ChargeResource name="2nd level" charges={2} spend={1}/>
                </Grouping>
                <Grouping name="Items">
