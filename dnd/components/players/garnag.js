        ...
        return (
            <Player name="Garnag">
                <Grouping name="Resources">
                    ...
                    <ChargeResource name="Hit Die" charges={5} spend={3} onShortRest={(spend) => spend - 1 < 0 ? 0 : spend - 1} />
                ...
                <Grouping name="Class abilities">
                    <ChargeResource name="Maneuvers" charges={4} spend={1} onShortRest={(_) => 0} />
                    <ChargeResource name="Second Wind" charges={1} spend={1} onShortRest={(_) => 0} />
                    <ChargeResource name="Action Surge" charges={1} spend={1} onShortRest={(_) => 0} />
                </Grouping>
                <Grouping name="Items">
                    <ChargeResource name="Yohn's Sword of Retribution" charges={4} spend={1}/>
