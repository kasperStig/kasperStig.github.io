        ...
        return (
            <Player name="Garnag">
                ...
                <Grouping name="Racial abilities">
                    <ChargeResource name="Relentless Endurance" charges="1" spend="1" />
                </Grouping>
                <Grouping name="Class abilities">
                    <ChargeResource name="Maneuvers" charges="4" spend="2" />
                    <ChargeResource name="Second Wind" charges="1" spend="1"/>
                    <ChargeResource name="Action Surge" charges="1" spend="1" />
                </Grouping>
                <Grouping name="Items">
                    <ChargeResource name="Yohn's Sword of Retribution" charges="3" spend="2"/>
